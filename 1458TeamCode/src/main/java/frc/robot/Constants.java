...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double trackWidth = Units.inchesToMeters(23.5); // TODO: This must be tuned to specific
                                                                            // robot
        ...
        public static final int driveCurrentLimit = 30; // dc.11.9.24 reduce max current per motor, total current needs
                                                        // to time motor-count(8)
        ...
        /** Meters per Second */
        public static final double maxSpeed = 0.1; // TODO: dc 11.9.24, increase max speed so that we can observe
                                                   // amplified drivetrain bahavior
        /** Radians per Second */
        ...
        public static final class FrontLeftMod { // TODO: This must be tuned to specific robot
            ...
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset, isDriveInverted, isAngleInverted);
        }
    ...
    public static final class SwerveConstants {
        ...
        /*
         * dc.10.21.2024 mapping existing constants so that ported citrus code only
         * needs minimal changes
         */
        public static final SwerveDriveKinematics kKinematics = Swerve.swerveKinematics;
        // public static final boolean driveMotorInvert = false; //TODO: need to verify
        // with the actual Robot setting
        // public static final boolean angleMotorInvert = true; //TODO: need to verify
        // with the actual Robot setting
        ...
        public static final double driveGearRatio = Swerve.chosenModule.driveGearRatio;// ?? Constants.isEpsilon ? 5.82
                                                                                       // : 5.82;
        ...
        public static final double kV = 12 * Math.PI * wheelDiameter / (driveGearRatio * maxSpeed); // TODO: need to
                                                                                                    // finetune with the
                                                                                                    // actual robot
        ...
        public static TalonFXConfiguration AzimuthFXConfig() {
            ...
            config.CurrentLimits.SupplyCurrentThreshold = Swerve.angleCurrentThreshold;// add this to limit current
                                                                                       // spiking
        ...
        public static TalonFXConfiguration DriveFXConfig() {
            ...
            config.CurrentLimits.SupplyCurrentThreshold = Swerve.driveCurrentThreshold;// add this to limit current
                                                                                       // spiking
    ...
    /*
     * dc.10.21.2024 extra constants needed during porting of citrus
     * SwerveModule.java code
     */
