...
public class Elevator extends SubsystemBase {
  ...
  private final PWMSparkMax m_motor = new PWMSparkMax(Constants.Elevator.kMotorPort);
  ...
  private final Mechanism2d m_mech2d = new Mechanism2d(20.0, 50.0);
  private final MechanismRoot2d m_mech2dRoot = m_mech2d.getRoot("Elevator", 10.0, 0.0);
  ...
  public Elevator() {
    m_encoder.setDistancePerPulse(Constants.Elevator.kElevatorEncoderDistPerPulse);
