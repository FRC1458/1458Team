...
public class Shooter extends Subsystem {
  ...
  private TalonFXConfiguration setUpMotors() {
  ...
  private Shooter() {
    ...
    mLeftShooterMotor.getConfigurator().apply(setUpMotors(),Constants.kLongCANTimeoutMs);
    mRightShooterMotor.getConfigurator().apply(setUpMotors(),Constants.kLongCANTimeoutMs);
